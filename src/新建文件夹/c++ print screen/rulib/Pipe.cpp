...
BOOL CPipe::Write(LPVOID buf, DWORD size, LPDWORD written)
{_STTEX();
...
BOOL CPipe::OnWrite(LPVOID buf, DWORD size, LPDWORD written)
{_STTEX();
	// Process the write
...
BOOL CPipe::ProcessWrite(LPVOID buf, DWORD size, LPDWORD written)
{_STTEX();
	LPVOID b = m_ubuf;
	DWORD s = m_usize;
...
BOOL CPipe::OnWriteComplete(LPVOID buf, DWORD size, LPDWORD written)
{_STTEX();
	// Count bytes written
	m_writecount += size;
