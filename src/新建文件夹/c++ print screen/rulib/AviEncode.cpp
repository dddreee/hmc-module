...
{_STT();
	...
	{	m_avi.OpenNew( m_szFile, &m_rAvi, m_dwFrames, m_dwSeconds, m_dwFourCC, NULL, 0, FALSE );
...
BOOL CAviEncode::StartRecording(LPCTSTR pFile, LPRECT pRect, DWORD dwFrames, DWORD dwSeconds, DWORD dwFourCC)
{_STT();
