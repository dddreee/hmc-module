...
public:
	...
	*/
	...
	{	
		...
		return AddElement( hGroup, pName, CFG_DOUBLE, strlen( num ), (LPVOID)num );
	}
	...
	*/
	BOOL GetValue( HGROUP hGroup, LPCTSTR pName, double *pdValue )
	{
		...
		if ( pcei == NULL ) return FALSE;
		char *end;
		*pdValue = strtod( (char*)pcei->value, &end );
		return TRUE;
	}
	...
	*/
	...
	/**
		...
		\see 
	*/
	void SetTerminator( BYTE term ) { m_ucTerm = term; }
